...
MASTER_ADDRESS=${1:-"192.168.45.53"}
ETCD_SERVERS=${2:-"http://192.168.45.53:2379"}
SERVICE_CLUSTER_IP_RANGE=${3:-"10.254.0.0/24"}
ADMISSION_CONTROL=${4:-"NamespaceLifecycle,LimitRanger,DefaultStorageClass,ResourceQuota"}
